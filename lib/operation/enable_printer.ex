defmodule Hippy.Operation.EnablePrinter do
  @moduledoc """
  Represents a request to enable a printer on the IPP server.
  """
...
defimpl Hippy.Operation, for: Hippy.Operation.EnablePrinter do
  def build_request(op) do
    ...
    %Hippy.Request{
      ...
      operation_id: Hippy.Protocol.Operation.enable_printer(),
